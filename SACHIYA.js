...
case 'webtonsearch': case 'webtoon':
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return reply(anu.message)
                GojoMdNx.sendText(m.chat, `🇱🇰 *Name :* ${anu.message.nama}\🇱🇰 *Meaning :* ${anu.message.arti}\n🇱🇰 *Notes :* ${anu.message.catatan}`, m)
            }
            break
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hi ${pushname}`,
                    description: `           🇱🇰  Please Choose The Menu 🇱🇰\nSACHIYA MD IS AN MODIFIED VERSION OF THE GOJOSENSEI BOT .THANK FOR USING SACHIYA MD.THIS IS MULTIFUNCTIONAL WHATSAPP BOT SO DONT USE BOT FOR BAD THINGS\n\n`,
                    buttonText: "Menu",
